                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="author_meta">
                            <div><strong>Author</strong></div><div><?=get_field('author')?></div>
                            <?php
                            if (get_field('series') ?? null) {
                                ?>
                            <div><strong>Series</strong></div><div><?=get_field('series')?>
                                <?php
                            ...
                            <div><strong>Purchased</strong></div><div><?=get_the_date()?></div>
                        </div>
                    </div>
                </div>
                <?php
